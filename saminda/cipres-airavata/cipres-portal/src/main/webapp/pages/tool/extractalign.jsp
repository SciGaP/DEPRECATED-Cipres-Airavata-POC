...
<h2>Extractalign: Extract a region from a sequence alignment (<a href="#REFERENCE">Gary Williams</a>)</h2>
<s:form action="extractalign" theme="simple">
...
var element = document.forms['extractalign'].elements[parameter];
if (element == null)
return null;
