...
<h2>Seqretsplit: Split a multiple sequences file into many files, each containing one sequence (<a href="#REFERENCE">Gary Williams</a>)</h2>
<s:form action="seqretsplit" theme="simple">
...
var element = document.forms['seqretsplit'].elements[parameter];
if (element == null)
return null;
