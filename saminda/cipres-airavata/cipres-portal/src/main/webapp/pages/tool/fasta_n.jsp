...
<title>Fasta N</title>
<h2>Fasta N: Find Similar NS from Databases (<a href="#REFERENCE">W. Pearson</a>)</h2>
<s:form action="fasta_n" theme="simple">
...
<font color="red" size="3">*</font>
<s:radio name="fasta_"
list="#{ 'fasta_t':'fasta: protein or DNA query vs similar db (FASTA release 3.0)' }" onclick="resolveParameters()"/>
<br/>
...
<dd>fasta - scan a DNA sequence library for similar sequences</dd>
<br></br>
...
// seqtype
// nucleotid_db
if ( (getValue('seqtype_')=="DNA" && getValue('fasta_').match("^fasta") ) || getValue('fasta_').match("^tfast") )
...
var element = document.forms['fasta_n'].elements[parameter];
if (element == null)
return null;
