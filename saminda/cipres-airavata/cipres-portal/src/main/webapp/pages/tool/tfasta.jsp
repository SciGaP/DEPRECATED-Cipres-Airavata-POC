...
<title>TFasta</title>
<h2>TFasta: Compare a PS to Translated NS DB (<a href="#REFERENCE">W. Pearson</a>)</h2>
<s:form action="tfasta" theme="simple">
...
<font color="red" size="3">*</font>
<s:radio name="fasta_"
list="#{ 'tfasta':'tfasta: protein query vs translated DNA db' }" onclick="resolveParameters()"/>
<br/>
...
<dd>. tfasta - compare a protein sequence to a DNA sequence library, translating the DNA sequence library
`on-the-fly' to the 3 forward and the 3 reverse frames without frameshifts.</dd>
<br></br>
...
These characters are treated as 'X' during the initial scan, but are treated as normal residues during the
final alignment. Sinces statistical significance is calculated from similarity score calculated during library
...
score obtainded during the search.</dd>
</div>
</div>
<script type="text/javascript">
...
var element = document.forms['tfasta'].elements[parameter];
if (element == null)
return null;
