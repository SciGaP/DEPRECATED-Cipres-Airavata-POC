...
<title>Kitsch</title>
<h2>Kitsch: Fitch-Margoliash/Lst Sqrs Methods with Molecular Clock (<a href="#REFERENCE">Felsenstein</a>)</h2>
<s:form action="kitsch" theme="simple">
...
list="#{ '': '[Not Mandatory]', 'F':'Fitch-Margoliash' , 'M':'Minimum Evolution' }" onclick="resolveParameters()"/>
<br/>
...
<dd>For the Fitch-Margoliash method (default); P = 2.0. For the Cavalli-Sforza and Edwards least squares
...
<dd>A tree can be added by up-loading a Newick tree in a separate file.</dd>
<br></br>
...
var element = document.forms['kitsch'].elements[parameter];
if (element == null)
return null;
