...
<title>TBlastX</title>
<h2>TBlastX: Compare a translated NS to a translated DB (<a href="#REFERENCE">Altschul, Madden, Schaeffer, Zhang, Miller, Lipman</a>)</h2>
<s:form action="tblastx" theme="simple">
...
list="#{ 'tblastx':'tblastx: nucleotide query transl. / transl. nucleotide db' }" onclick="resolveParameters()"/>
<br/>
...
<dd>Causes NCBI gi identifiers to be shown in the output along with accession and/or locus name. </dd><dd>Warning: only available for NCBI db's such as nrprot.</dd>
...
var element = document.forms['tblastx'].elements[parameter];
if (element == null)
return null;
