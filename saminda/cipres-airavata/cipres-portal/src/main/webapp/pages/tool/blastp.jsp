...
<title>BlastP</title>
<h2>BlastP: Search DBs for Protein Sequence similarity (<a href="#REFERENCE">Altschul, Madden, Schaeffer, Zhang, Miller, Lipman</a>)</h2>
<s:form action="blastp" theme="simple">
...
list="#{ 'blastp':'blastp: amino acid query / protein db' }" onclick="resolveParameters()"/>
<br/>
...
<dd>blastp compares an amino acid query sequence against a protein sequence database</dd>
...
<dd>Causes NCBI gi identifiers to be shown in the output along with the accession and/or locus name. </dd><dd>Warning: only available for NCBI db's such as NCBI_NR: NCBI Non-Redundant.</dd>
...
// show_gi
if (getValue('protein_db_')=="NCBI_NR")
enable('show_gi_');
...
var element = document.forms['blastp'].elements[parameter];
if (element == null)
return null;
