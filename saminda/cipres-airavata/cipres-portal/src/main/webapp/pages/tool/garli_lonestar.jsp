...
<title>GARLI on Lonestar</title>
<h2>GARLI on Lonestar: Genetic Algorithm for Rapid Likelihood Inference - run on teragrid. (<a href="#REFERENCE">Derrick J. Zwickl (zwickl@nescent.org)</a>)</h2>
<s:form action="garli_lonestar" theme="simple">
...
<font color="red" size="3">+</font>
<s:select name="bootstrapreps_" list="#{ '0':'0' , '4':'4' , '8':'8' , '12':'12' , '16':'16' , '20':'20' , '24':'24' , '28':'28' , '32':'32' , '36':'36' , '40':'40' , '44':'44' , '48':'48' , '52':'52' , '56':'56' , '60':'60' , '64':'64' , '68':'68' , '72':'72' , '76':'76' , '80':'80' , '84':'84' , '88':'88' , '92':'92' , '96':'96' , '100':'100' }" onchange="resolveParameters()"/>
<br/>
<br/>
...
alert('Maximum Hours to Run must be between 0.1 - 48.0.');
return false;
}
// datatype_value
// geneticcode_value
...
if (getValue('searchreps_value_') > 12) {
alert('Sorry, the number of searchreps must be no more than 12.');
return false;
}
// bootstrapreps
if (!getValue('inferinternalstateprobs_g_')) {
...
var element = document.forms['garli_lonestar'].elements[parameter];
if (element == null)
return null;
