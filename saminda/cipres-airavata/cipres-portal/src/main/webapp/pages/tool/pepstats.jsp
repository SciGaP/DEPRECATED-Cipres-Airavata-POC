...
<h2>Pepstats: Calculate Protein statistics for PS </h2>
<s:form action="pepstats" theme="simple">
...
<s:checkbox name="termini_" onclick="resolveParameters()"/>
<br/>
Amino acid data file (-<A HREF="javascript:help.slidedownandjump('#aadata')">aadata</A>)
<font color="red" size="3">*</font>
<s:textfield name="aadata_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
<hr/>
...
<dt><a name=aadata><i>Amino acid data file (-aadata)</i></a></dt>
<dd>Molecular weight data for amino acids</dd>
<br></br>
...
var element = document.forms['pepstats'].elements[parameter];
if (element == null)
return null;
