...
<title>PAUPRat</title>
<h2>PAUPRat: Parsimony ratchet searches using PAUP* (<a href="#REFERENCE">Derek Sikes and Paul O. Lewis; David Swofford is the author of PAUP; Kevin Nixon is author of the Ratchet</a>)</h2>
<s:form action="pauprat" theme="simple">
...
<br/>
Specify an Outgroup
<s:checkbox name="set_outgroup_" onclick="resolveParameters()"/>
<br/>
Enter Your Outgroup Here
<s:textfield name="set_outgroupb_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
</div>
</div>
<script type="text/javascript">
...
// set_outgroup
// set_outgroupb
if (getValue('set_outgroup_'))
enable('set_outgroupb_');
else disable('set_outgroupb_');
}
...
var element = document.forms['pauprat'].elements[parameter];
if (element == null)
return null;
