...
public class beast_tg_test extends ToolParameters
{
...
public String getBeagle_scaling_()
{return getToolParameters().get("beagle_scaling_");
}
public void setBeagle_scaling_(String beagle_scaling_)
{ getToolParameters().put("beagle_scaling_", beagle_scaling_);
}
