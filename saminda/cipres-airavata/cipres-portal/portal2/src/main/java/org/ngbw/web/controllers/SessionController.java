...
public class SessionController
{
	...
	public User getUserByEmail(String email) {
		if (email == null) {
			...
			reportError(error, "Error retrieving user with email address \"" + email + "\"");
			return null;
		}
	}
	 ...
	 * @param organization	The primary organization with which the user
		...
		String organization) 
	{
		...
		return doRegisterUser(username, password, email, firstName, lastName, organization, UserRole.STANDARD);
	}
	...
	{
		return registerUser(username, password, email, firstName, lastName, organization, UserRole.STANDARD);
	}

	// Password is required. 
	public ValidationResult registerUser(String username, String password, String email,
		String firstName, String lastName, String organization, UserRole role) 
	{
		return doRegisterUser(username, password, email, firstName, lastName, organization, UserRole.STANDARD);
	}
	...
	private ValidationResult doRegisterUser(String username, String password, String email,
		...
		try 
		{
			...
			if (organization != null && organization.trim().equals("") == false)
				user.setInstitution(organization);
			user.setRole(role);
			// register user
	...
	public ValidationResult registerGuestUser() {
		...
		ValidationResult result = registerUser(guestName, guestNumber, guestNumber,
			"Guest", "User", null, UserRole.GUEST);
		WorkbenchSession session = getWorkbenchSession();
	 ...
	 * 			false otherwise
	 */
	public boolean editUser(String email, String firstName, String lastName,
