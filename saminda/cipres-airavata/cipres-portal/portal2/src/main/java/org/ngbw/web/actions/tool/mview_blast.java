...
public class mview_blast extends ToolParameters
{
// file-typed property getters and setters
public Long getBlast_output_()
{
return getInputDataItemId("blast_output_");
}
public void setBlast_output_(Long blast_output_)
{
setInputDataItem("blast_output_",blast_output_);
}
...
{return getToolParameters().get("register_");
}
public void setRegister_(String register_)
{ getToolParameters().put("register_", register_);
}
...
public String getSrs_()
{return getToolParameters().get("srs_");
}
public void setSrs_(String srs_)
{ getToolParameters().put("srs_", srs_);
}
public String getHsp_()
{return getToolParameters().get("hsp_");
}
public void setHsp_(String hsp_)
{ getToolParameters().put("hsp_", hsp_);
}
...
public String getMaxpval_()
{return getToolParameters().get("maxpval_");
}
public void setMaxpval_(String maxpval_)
{ getToolParameters().put("maxpval_", maxpval_);
}
public String getMinscore_()
{return getToolParameters().get("minscore_");
}
public void setMinscore_(String minscore_)
{ getToolParameters().put("minscore_", minscore_);
}
public String getMaxeval_()
{return getToolParameters().get("maxeval_");
}
public void setMaxeval_(String maxeval_)
{ getToolParameters().put("maxeval_", maxeval_);
}
public String getMinbits_()
{return getToolParameters().get("minbits_");
}
public void setMinbits_(String minbits_)
{ getToolParameters().put("minbits_", minbits_);
}
public String getCycle_()
{return getToolParameters().get("cycle_");
}
public void setCycle_(String cycle_)
{ getToolParameters().put("cycle_", cycle_);
}
public String getMinopt_()
{return getToolParameters().get("minopt_");
}
public void setMinopt_(String minopt_)
{ getToolParameters().put("minopt_", minopt_);
}
public String getFasta_strand_()
{return getToolParameters().get("fasta_strand_");
}
public void setFasta_strand_(String fasta_strand_)
{ getToolParameters().put("fasta_strand_", fasta_strand_);
}
