...
public class raxmlhpc2_tgb extends ToolParameters
{
...
public String getMore_memory_()
{return getToolParameters().get("more_memory_");
}
public void setMore_memory_(String more_memory_)
{ getToolParameters().put("more_memory_", more_memory_);
}
public String getNchar_()
{return getToolParameters().get("nchar_");
}
public void setNchar_(String nchar_)
{ getToolParameters().put("nchar_", nchar_);
}
public String getNtax_()
{return getToolParameters().get("ntax_");
}
public void setNtax_(String ntax_)
{ getToolParameters().put("ntax_", ntax_);
}
...
public String getMulcustom_aa_matrices_()
{return getToolParameters().get("mulcustom_aa_matrices_");
}
public void setMulcustom_aa_matrices_(String mulcustom_aa_matrices_)
{ getToolParameters().put("mulcustom_aa_matrices_", mulcustom_aa_matrices_);
}
// file-typed property getters and setters
public Long getUser_prot_matrixq1_()
{
return getInputDataItemId("user_prot_matrixq1_");
}
public void setUser_prot_matrixq1_(Long user_prot_matrixq1_)
{
setInputDataItem("user_prot_matrixq1_",user_prot_matrixq1_);
}
// file-typed property getters and setters
public Long getUser_prot_matrixq2_()
{
return getInputDataItemId("user_prot_matrixq2_");
}
public void setUser_prot_matrixq2_(Long user_prot_matrixq2_)
{
setInputDataItem("user_prot_matrixq2_",user_prot_matrixq2_);
}
// file-typed property getters and setters
public Long getUser_prot_matrixq3_()
{
return getInputDataItemId("user_prot_matrixq3_");
}
public void setUser_prot_matrixq3_(Long user_prot_matrixq3_)
{
setInputDataItem("user_prot_matrixq3_",user_prot_matrixq3_);
}
// file-typed property getters and setters
public Long getUser_prot_matrixq4_()
{
return getInputDataItemId("user_prot_matrixq4_");
}
public void setUser_prot_matrixq4_(Long user_prot_matrixq4_)
{
setInputDataItem("user_prot_matrixq4_",user_prot_matrixq4_);
}
// file-typed property getters and setters
public Long getUser_prot_matrixq5_()
{
return getInputDataItemId("user_prot_matrixq5_");
}
public void setUser_prot_matrixq5_(Long user_prot_matrixq5_)
{
setInputDataItem("user_prot_matrixq5_",user_prot_matrixq5_);
}
...
public String getAncestral_states_()
{return getToolParameters().get("ancestral_states_");
}
public void setAncestral_states_(String ancestral_states_)
{ getToolParameters().put("ancestral_states_", ancestral_states_);
}
...
public String getFast_tree_()
{return getToolParameters().get("fast_tree_");
}
public void setFast_tree_(String fast_tree_)
{ getToolParameters().put("fast_tree_", fast_tree_);
}
