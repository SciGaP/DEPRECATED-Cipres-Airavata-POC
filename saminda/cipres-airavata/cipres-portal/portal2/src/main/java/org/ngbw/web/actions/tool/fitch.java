...
public class fitch extends ToolParameters
{
...
public String getUse_lengths_()
{return getToolParameters().get("use_lengths_");
}
public void setUse_lengths_(String use_lengths_)
{ getToolParameters().put("use_lengths_", use_lengths_);
}
...
{return getToolParameters().get("global_");
}
public void setGlobal_(String global_)
{ getToolParameters().put("global_", global_);
}
