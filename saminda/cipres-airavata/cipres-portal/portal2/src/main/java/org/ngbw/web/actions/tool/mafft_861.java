...
public class mafft_861 extends ToolParameters
{
...
public String getNum_seqs_()
{return getToolParameters().get("num_seqs_");
}
public void setNum_seqs_(String num_seqs_)
{ getToolParameters().put("num_seqs_", num_seqs_);
}
...
public String getGroup2groupalg_()
{return getToolParameters().get("group2groupalg_");
}
public void setGroup2groupalg_(String group2groupalg_)
{ getToolParameters().put("group2groupalg_", group2groupalg_);
}
