...
public class garli_lonestar extends ToolParameters
{
...
// file-typed property getters and setters
public Long getStreefname_userdata_()
{
return getInputDataItemId("streefname_userdata_");
}
public void setStreefname_userdata_(Long streefname_userdata_)
{
setInputDataItem("streefname_userdata_",streefname_userdata_);
}
...
// file-typed property getters and setters
public Long getConstraintfile_control_()
{
return getInputDataItemId("constraintfile_control_");
}
public void setConstraintfile_control_(Long constraintfile_control_)
{
setInputDataItem("constraintfile_control_",constraintfile_control_);
}
