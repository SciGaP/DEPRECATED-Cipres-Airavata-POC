...
<title>MrBayes</title>
<h2>MrBayes: Tree Inference Using Bayesian Analysis (<a href="#REFERENCE">John P. Huelsenbeck and Fred Ronquist</a>)</h2>
<s:form action="mrbayes" theme="simple">
...
var element = document.forms['mrbayes'].elements[parameter];
if (element == null)
return null;
