...
<title>RAxML-HPC2 on XSEDE I </title>
<h2>RAxML-HPC2 on XSEDE I : Phylogenetic tree inference using maximum likelihood/rapid bootstrapping run on XSEDE (<a href="#REFERENCE">Alexandros Stamatakis</a>)</h2>
<s:form action="raxmlhpc2_tgbi" theme="simple">
...
<br/>
<br/>
<A HREF="javascript:help.slidedownandjump('#invariable')">Estimate proportion of invariable sites (GTRGAMMA + I)</A>
<font color="red" size="3">+</font>
...
<dt><a name=invariable><i>Estimate proportion of invariable sites (GTRGAMMA + I)</i></a></dt>
<dd>This option is not recommended by the devloper. See the RAxML 7.0.4 manual.</dd>
...
// invariable
if (getValue('prot_sub_model_')=="PROTGAMMA")
enable('invariable_');
...
if (getValue('specify_runs_')) {
if (getValue('altrun_number_') > 50) {
alert('Sorry, the value for alternative runs must 50 or less');
return false;
}
}
// bipartitions
...
if ((getValue('bootstrap_seed_') || getValue('mulparambootstrap_seed_')) && !getValue('use_bootstopping_') && !getValue('startingtreeonly_')) {
if (getValue('bootstop_') > 1000) {
alert('Sorry, the value of bootstraps cannot exceed 1,000');
return false;
}
}
// use_bootstopping
...
// runtime
if (getValue('specify_bootstraps_') && getValue('bootstop_')< 50)
{
...
if (!getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('specify_runs_'))
{
if (!confirm(messageSplit("The job will run on 32 processors as configured. If it runs for the entire configured time, it will consume 32 x getValue('runtime_') cpu hours")))
{
return false;
...
var element = document.forms['raxmlhpc2_tgbi'].elements[parameter];
if (element == null)
return null;
