...
<h2>HelixTurnHelix: Find nucleic acid binding motifs in protein structures </h2>
<s:form action="helixturnhelix" theme="simple">
...
<s:textfield name="mean_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
Standard Deviation value (-sd)
<font color="red" size="3">*</font>
<s:textfield name="sd_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
Minimum SD (-minsd)
<font color="red" size="3">*</font>
<s:textfield name="minsd_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
Use the old (1987) weight data (-eightyseven)
<font color="red" size="3">*</font>
<s:checkbox name="eightyseven_" onclick="resolveParameters()"/>
<br/>
<hr/>
...
var element = document.forms['helixturnhelix'].elements[parameter];
if (element == null)
return null;
