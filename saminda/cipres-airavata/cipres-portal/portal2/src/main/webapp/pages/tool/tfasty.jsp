...
<title>TFastY</title>
<h2>TFastY: Compare PS to Translated NS Or NS-DB (<a href="#REFERENCE">W. Pearson</a>)</h2>
<s:form action="tfasty" theme="simple">
...
<font color="red" size="3">*</font>
<s:radio name="fasta_"
list="#{ 'tfasty':'tfasty = tfastx + frameshifts anywhere' }" onclick="resolveParameters()"/>
<br/>
...
<dd>. tfastx/tfasty - compare a protein sequence vs a translated DNA db, with frameshifts. tfasty allows frameshifts inside codons.</dd>
<br></br>
...
<dd>Treat lower-case characters in the query or library sequence as 'low-complexity' residues. These
...
search, low complexity regions will not produce statistical significant matches.</dd><dd>If a significant alignment contains low complexity regions the final score may be higher than the
score obtained during the search.</dd>
</div>
</div>
<script type="text/javascript">
...
var element = document.forms['tfasty'].elements[parameter];
if (element == null)
return null;
