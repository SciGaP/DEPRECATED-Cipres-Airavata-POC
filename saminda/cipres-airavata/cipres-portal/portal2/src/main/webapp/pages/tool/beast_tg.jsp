...
<title>BEAST on XSEDE</title>
<h2>BEAST on XSEDE: Bayesian Evolutionary Analysis by Sampling Trees - run on XSEDE (<a href="#REFERENCE">John P. Huelsenbeck and Fred Ronquist</a>)</h2>
<s:form action="beast_tg" theme="simple">
<!-- Begin Simple Parameters -->
<a href="javascript:simple.slideit()" class="panel">Simple Parameters</a>
<div id="simple" style="width: 100%; background-color: #FFF;">
<div style="padding: 0.75em 0 0 0">
<A HREF="javascript:help.slidedownandjump('#runtime')">Maximum Hours to Run (up to 334 hours)</A>
...
<div style="padding: 0.75em 0 0 0">
<dt><a name=runtime><i>Maximum Hours to Run (up to 334 hours)</i></a></dt>
...
// runtime
if (!getValue('no_beagle_') && getValue('runtime_')!=0 )
{
...
if (getValue('no_beagle_') && getValue('runtime_')!=0 )
{
if (!confirm(messageSplit("The job will run on 1 processor as configured (jobs without BEAGLE run on a single processor. If it runs for the entire configured time, it will consume 1 x getValue('runtime_') cpu hours")))
{
return false;
}
}
...
var element = document.forms['beast_tg'].elements[parameter];
if (element == null)
return null;
