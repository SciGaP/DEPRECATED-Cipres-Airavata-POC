...
<h2>Running Echo in Localhost: Test description (<a href="#REFERENCE">Saminda</a>)</h2>
<s:form action="echo_workflow" theme="simple">
...
var element = document.forms['echo_workflow'].elements[parameter];
if (element == null)
return null;
