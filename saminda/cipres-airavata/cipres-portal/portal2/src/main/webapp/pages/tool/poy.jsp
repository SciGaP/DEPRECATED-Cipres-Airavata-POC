...
<title>POY</title>
<h2>POY: Phylogenetic tree inference using dynamic homologies. (<a href="#REFERENCE">Andres Varon, Le Sy Vinh, Illya Bomash, and Ward Wheeler</a>)</h2>
<s:form action="poy" theme="simple">
...
<dt><a name=infile1><i>Input File</i></a></dt>
<dd>
...
var element = document.forms['poy'].elements[parameter];
if (element == null)
return null;
