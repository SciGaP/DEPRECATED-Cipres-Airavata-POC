...
<title>MrBayes on Gordon</title>
<h2>MrBayes on Gordon: Tree Inference Using Bayesian Analysis - run on XSEDE (<a href="#REFERENCE">John P. Huelsenbeck and Fred Ronquist</a>)</h2>
<s:form action="mrbayeshybrid_gordon" theme="simple">
...
alert('The maximum hours to run must be less than 334');
return false;
}
...
var element = document.forms['mrbayeshybrid_gordon'].elements[parameter];
if (element == null)
return null;
