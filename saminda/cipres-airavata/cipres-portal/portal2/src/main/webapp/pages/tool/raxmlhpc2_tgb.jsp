...
<h2>RAxML-HPC2 on XSEDE: Phylogenetic tree inference using maximum likelihood/rapid bootstrapping run on XSEDE (<a href="#REFERENCE">Alexandros Stamatakis</a>)</h2>
<s:form action="raxmlhpc2_tgb" theme="simple">
...
<br/>
<A HREF="javascript:help.slidedownandjump('#more_memory')">I have a data set that may require more than 125 GB of memory</A>
<font color="red" size="3">*</font>
<s:checkbox name="more_memory_" onclick="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#nchar')">Enter the number of patterns in your dataset</A>
<s:textfield name="nchar_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#ntax')">Enter the number of taxa in your dataset</A>
<s:textfield name="ntax_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
Sequence Type
<font color="red" size="3">*</font>
<s:select name="datatype_" list="#{ 'protein':'Protein' , 'dna':'Nucleotide' , 'rna':'RNA Structure' , 'binary':'Binary Morphological' , 'multi':'Multi-State Morphological' }" onchange="resolveParameters()"/>
<br/>
<br/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#invariable')">Estimate proportion of invariable sites (GTRGAMMA + I) (only active with -f a option)</A>
<font color="red" size="3">*</font>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#mulcustom_aa_matrices')">Use a Partition file that specifies AA Matrices</A>
<s:checkbox name="mulcustom_aa_matrices_" onclick="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#user_prot_matrixq1')">Select the First Protein Substitution Matrix Called in Your Partition File</A>
<s:select name="user_prot_matrixq1_" headerKey='' headerValue='' list="%{ getDataForParameter('user_prot_matrixq1_')}" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#user_prot_matrixq2')">Select the Second Protein Substitution Matrix Called in Your Partition File</A>
<s:select name="user_prot_matrixq2_" headerKey='' headerValue='' list="%{ getDataForParameter('user_prot_matrixq2_')}" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#user_prot_matrixq3')">Select the Third Protein Substitution Matrix Called in Your Partition File</A>
<s:select name="user_prot_matrixq3_" headerKey='' headerValue='' list="%{ getDataForParameter('user_prot_matrixq3_')}" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#user_prot_matrixq4')">Select the Fourth Protein Substitution Matrix Called in Your Partition File</A>
<s:select name="user_prot_matrixq4_" headerKey='' headerValue='' list="%{ getDataForParameter('user_prot_matrixq4_')}" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#user_prot_matrixq5')">Select the Fifth Protein Substitution Matrix Called in Your Partition File</A>
<s:select name="user_prot_matrixq5_" headerKey='' headerValue='' list="%{ getDataForParameter('user_prot_matrixq5_')}" onchange="resolveParameters()"/>
<br/>
...
<br/>
<hr/>
<A name=multi_opts><h2><A HREF="javascript:help.slidedownandjump('#multi_opts_comment')">Multiple State Morphological Matrix Options</A></H2>
<A HREF="javascript:help.slidedownandjump('#multi_model')">Multiple State Data Model (-m)</A>
<font color="red" size="3">+</font>
<s:radio name="multi_model_"
list="#{ 'MULTICAT':'Multi-state CAT' , 'MULTIGAMMA':'Multi-state GAMMA' }" onclick="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#choose_multi_model')">Select a Multiple state data model (-K)</A>
<font color="red" size="3">+</font>
<s:radio name="choose_multi_model_"
list="#{ 'ORDERED':'Ordered' , 'MK':'MK' , 'GTR':'GTR' }" onclick="resolveParameters()"/>
<br/>
<hr/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#ancestral_states')">Compute Marginal Ancestral States using a rooted reference tree. (-f A)</A>
<s:checkbox name="ancestral_states_" onclick="resolveParameters()"/>
<br/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#fast_tree')">Run very fast experimental tree search(-f E)</A>
<font color="red" size="3">+</font>
<s:checkbox name="fast_tree_" onclick="resolveParameters()"/>
<br/>
<hr/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#mr_bootstopping')">Stop Bootstrapping Automatically with Majority Rule Criterion (recommended)</A>
<font color="red" size="3">+</font>
<s:checkbox name="mr_bootstopping_" onclick="resolveParameters()"/>
<br/>
Select Majority Rule Criterion: (autoMRE is recommended)
<font color="red" size="3">+</font>
...
<dd>Estimate the maximum time your job will need to run. We recommend testimg initially with a time less than 0.5hr test run because Jobs set for 0.5 h or less depedendably run immediately in the "debug" queue.
Once you are sure the configuration is correct, you then increase the time. The reason is that jobs > 0.5 h are submitted to the "normal" queue, where jobs configured for 1 or a few hours times may
run sooner than jobs configured for the full 168 hours.
</dd>
<dt><a name=more_memory><i>I have a data set that may require more than 125 GB of memory</i></a></dt>
<dd>To figure out if you need this option, use the RAxML memory calculator here: http://sco.h-its.org/exelixis/software.html.
...
<dt><a name=nchar><i>Enter the number of patterns in your dataset</i></a></dt>
<dd>
...
<dt><a name=ntax><i>Enter the number of taxa in your dataset</i></a></dt>
<dd>
...
<dt><a name=invariable><i>Estimate proportion of invariable sites (GTRGAMMA + I) (only active with -f a option)</i></a></dt>
<dd>This option is not recommended by the developer of RAxML</dd>
...
<dt><a name=mulcustom_aa_matrices><i>Use a Partition file that specifies AA Matrices</i></a></dt>
<dd>This option can be used to specify multiple custom matrices via a partition file. The filenames must be specified as firstpartition, secondpartition, thirdpartition, fourthpartition, and fifthpartition, in order, </dd>
<dt><a name=user_prot_matrixq1><i>Select the First Protein Substitution Matrix Called in Your Partition File</i></a></dt>
<dd>This option allows the user to upload a Protein subsitution matrix</dd>
<dt><a name=user_prot_matrixq2><i>Select the Second Protein Substitution Matrix Called in Your Partition File</i></a></dt>
<dd>This option allows the user to upload a second Protein subsitution matrix</dd>
<dt><a name=user_prot_matrixq3><i>Select the Third Protein Substitution Matrix Called in Your Partition File</i></a></dt>
<dd>This option allows the user to upload a third Protein subsitution matrix</dd>
<dt><a name=user_prot_matrixq4><i>Select the Fourth Protein Substitution Matrix Called in Your Partition File</i></a></dt>
<dd>This option allows the user to upload a fourth Protein subsitution matrix</dd>
<dt><a name=user_prot_matrixq5><i>Select the Fifth Protein Substitution Matrix Called in Your Partition File</i></a></dt>
<dd>This option allows the user to upload a fifth Protein subsitution matrix</dd>
<br></br>
...
<br></br>
<dt><a name=multi_opts_comment><i><b>Multiple State Morphological Matrix Options</b></i></a></dt>
<dt><a name=multi_model><i>Multiple State Data Model (-m)</i></a></dt>
<dd>Multi-state morphological data are handled in RAXML at V. 7.3.0 and above. Multi-state CAT uses optimization of site-specific evolutionary rates which are categorized
into numberOfCategories distinct rate categories for greater computational efficiency. Final tree might be evaluated automatically under MULTIGAMMA depending on the tree search option </dd><dd>Mutli-state GAMMA uses the GAMMA model of rate heterogeneity (alpha parameter will be estimated). Invariable sites (I) options are not exposed here.
If you require this option, please contact mmiller@sdsc.edu.</dd>
<dt><a name=choose_multi_model><i>Select a Multiple state data model (-K)</i></a></dt>
<dd>Multi-state morphological data are handled in RAXML 7.3.0 and above. Multi-state CAT uses optimization of site-specific evolutionary rates which are categorized
into numberOfCategories distinct rate categories for greater computational efficiency. Final tree might be evaluated automatically under MULTIGAMMA depending on the tree search option </dd><dd>Mutli-state GAMMA uses the GAMMA model of rate heterogeneity (alpha parameter will be estimated). The program's author supports the use of Gamma models.</dd>
<br></br>
...
<dt><a name=ancestral_states><i>Compute Marginal Ancestral States using a rooted reference tree. (-f A)</i></a></dt>
<dd>When this is specified, RAxML draws the bipartitions using a bunch of topologies (typically boot-strapped trees) specified with -z onto a single tree topology specified by -t (typically the best-scoring ML tree). </dd>
...
<dt><a name=fast_tree><i>Run very fast experimental tree search(-f E)</i></a></dt>
<dd>Compute pair-wise ML distances, ML model parameters will be estimated on an MP starting tree or a user-defined tree passed via "-t".</dd>
<br></br>
...
<dt><a name=mr_bootstopping><i>Stop Bootstrapping Automatically with Majority Rule Criterion (recommended)</i></a></dt>
<dd>If you want to use the bootstopping criteria specify "-# autoMR" or "-# autoMRE" or "-# autoMRE_IGN" for the majority-rule tree based criteria (see -I option) or "-# autoFC" for the frequency-based criterion. Bootstopping will only work in combination with "-x" or "-b"</dd>
...
// runtime
// more_memory
if (getValue('datatype_')=="dna" || getValue('datatype_')=="protein")
enable('more_memory_');
else disable('more_memory_');
// nchar
if (getValue('more_memory_'))
enable('nchar_');
else disable('nchar_');
// ntax
if (getValue('more_memory_'))
...
// constraint
if (! getValue('binary_backbone_') && !getValue('startingtreeonly_') && !getValue('use_bootstopping_'))
enable('constraint_');
...
if (getValue('datatype_')=="protein")
enable('mulcustom_aa_matrices_');
else disable('mulcustom_aa_matrices_');
// user_prot_matrixq1
if (getValue('mulcustom_aa_matrices_'))
enable('user_prot_matrixq1_');
else disable('user_prot_matrixq1_');
// user_prot_matrixq2
if (getValue('mulcustom_aa_matrices_') && getValue('user_prot_matrixq1_'))
enable('user_prot_matrixq2_');
else disable('user_prot_matrixq2_');
// user_prot_matrixq3
if (getValue('mulcustom_aa_matrices_') && getValue('user_prot_matrixq2_'))
enable('user_prot_matrixq3_');
else disable('user_prot_matrixq3_');
// user_prot_matrixq4
if (getValue('mulcustom_aa_matrices_') && getValue('user_prot_matrixq3_'))
enable('user_prot_matrixq4_');
else disable('user_prot_matrixq4_');
// user_prot_matrixq5
if (getValue('mulcustom_aa_matrices_') && getValue('user_prot_matrixq4_'))
enable('user_prot_matrixq5_');
else disable('user_prot_matrixq5_');
// use_emp_freqs
if (getValue('datatype_')=="protein")
...
// multi_model
if (getValue('datatype_')=="multi")
enable('multi_model_');
else disable('multi_model_');
// choose_multi_model
if (getValue('datatype_')=="multi")
enable('choose_multi_model_');
else disable('choose_multi_model_');
// startingtreeonly
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') &&!getValue('bootstrap_seed_') && !getValue('bipartitions_') && ! getValue('constraint_') && !getValue('log_likelihood_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_'))
enable('startingtreeonly_');
else disable('startingtreeonly_');
// specify_runs
if (!getValue('fast_tree_') && !getValue('ancestral_states_') && !getValue('bootstrap_seed_') && !getValue('mulparambootstrap_seed_') && !getValue('bipartitions_') && !getValue('startingtreeonly_') && !getValue('log_likelihood_'))
...
// bipartitions
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') &&!getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('log_likelihood_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_'))
enable('bipartitions_');
else disable('bipartitions_');
// ancestral_states
if (!getValue('bipartitions_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') &&!getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('log_likelihood_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_'))
enable('ancestral_states_');
else disable('ancestral_states_');
// log_likelihood
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('bipartitions_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_'))
...
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('bipartitions_') && !getValue('startingtreeonly_') && !getValue('log_likelihood_') && !getValue('specify_runs_'))
enable('compute_ml_distances_');
else disable('compute_ml_distances_');
// fast_tree
if (!getValue('ancestral_states_') && !getValue('compute_ml_distances_') && !getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('bipartitions_') && !getValue('startingtreeonly_') && !getValue('log_likelihood_') && !getValue('specify_runs_'))
enable('fast_tree_');
else disable('fast_tree_');
// mulparambootstrap_seed
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('compute_ml_distances_') && !getValue('bipartitions_') && !getValue('log_likelihood_') && !getValue('compute_mr_') && !getValue('specify_runs_'))
...
// bootstrap_seed
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('compute_ml_distances_') && !getValue('bipartitions_') && !getValue('log_likelihood_') && !getValue('compute_mr_') && !getValue('specify_runs_'))
...
// mlsearch
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('bipartitions_') && !getValue('startingtreeonly_') && getValue('bootstrap_seed_') && !getValue('compute_ml_distances_'))
enable('mlsearch_');
...
// bootstop
if ((getValue('bootstrap_seed_') || getValue('mulparambootstrap_seed_')) && !getValue('use_bootstopping_') && !getValue('startingtreeonly_'))
enable('bootstop_');
...
// mrbootstopping_type
if (getValue('mr_bootstopping_') && !getValue('specify_bootstraps_') && getValue('use_bootstopping_'))
enable('mrbootstopping_type_');
else disable('mrbootstopping_type_');
// use_apobootstopping
if (!getValue('use_bootstopping_'))
enable('use_apobootstopping_');
else disable('use_apobootstopping_');
...
// runtime
if (getValue('runtime_') > 320.0) {
alert('Maximum Hours to Run must be less than 320');
return false;
}
// more_memory
// nchar
if (getValue('more_memory_')) {
if (! getValue('nchar_')) {
alert('Please enter a value for the number of patterns in your data matrix');
return false;
}
}
if (getValue('more_memory_')) {
if (getValue('nchar_') < 1) {
alert('The number of patterns in the matrix must 1 or greater.');
return false;
}
}
// ntax
if (getValue('more_memory_')) {
if (! getValue('ntax_')) {
alert('Please enter a value for the number of taxa in your data matrix');
return false;
}
}
if (getValue('more_memory_')) {
if (getValue('nchar_') < 1) {
alert('The number of taxa in the matrix must 1 or greater.');
return false;
}
}
if (getValue('more_memory_')) {
if (getValue('more_memory_') && getValue('datatype_')=="dna" && getValue('ntax_')*getValue('nchar_')*8*16 < 6.4 * (1024*1024*1024)) {
alert('Your job does not require the large memory option, please uncheck the large memory box and run normally.');
return false;
}
}
if (getValue('more_memory_')) {
if (getValue('more_memory_') && getValue('datatype_')=="dna" && getValue('ntax_')*getValue('nchar_')*8*16 > 64*(1024*1024*1024) ) {
alert('Your job will probably not complete as configured, please contact us for help.');
return false;
}
}
if (getValue('more_memory_')) {
if (getValue('more_memory_') && getValue('datatype_')=="protein" && getValue('ntax_')*getValue('nchar_')*8*80 < 6.4*(1024*1024*1024)) {
alert('Your job does not require the large memory option, please uncheck the large memory box and run normally.');
return false;
}
}
if (getValue('more_memory_')) {
if (getValue('more_memory_') && getValue('datatype_')=="protein" && getValue('ntax_')*getValue('nchar_')*8*80 > 64*(1024*1024*1024)) {
alert('Your job will probably not complete as configured, please contact us for help.');
return false;
}
}
...
// dna_gtrgamma
if (!getValue('dna_gtrcat_') && (getValue('datatype_')=="dna" || getValue('datatype_')=="rna") ) {
if ((getValue('datatype_')=="dna" || getValue('datatype_')=="rna") && !getValue('dna_gtrgamma_') && !getValue('dna_gtrcat_') ) {
alert('Please choose a DNA model');
return false;
}
}
// prot_sub_model
if (getValue('datatype_')=="protein") {
if (getValue('datatype_')=="protein" && getValue('prot_sub_model_')!="PROTGAMMA" && getValue('prot_sub_model_')!="PROTCAT" ) {
alert('Please choose a protein model');
return false;
}
}
// prot_matrix_spec
...
// mulcustom_aa_matrices
if (getValue('datatype_')=="protein") {
if (getValue('mulcustom_aa_matrices_') && ! getValue('partition_')) {
alert('Please choose a partition file specifying up to 5 partitions');
return false;
}
}
// user_prot_matrixq1
...
// bin_model
if (getValue('datatype_')=="binary") {
if (getValue('datatype_')=="binary" && getValue('bin_model_')!="BINCAT" && getValue('bin_model_')!="BINGAMMA" ) {
alert('Please choose a binary model');
return false;
}
}
// multi_model
if (getValue('datatype_')=="multi") {
if (getValue('datatype_')=="multi" && getValue('multi_model_')!="MULTICAT" && getValue('multi_model_')!="MULTIGAMMA" ) {
alert('Please choose a Multi-State model');
return false;
}
}
// choose_multi_model
if (getValue('datatype_')=="multi") {
if (getValue('datatype_')=="multi" && getValue('choose_multi_model_')!="ORDERED" && getValue('choose_multi_model_')!="MK" && getValue('choose_multi_model_')!="GTR" ) {
alert('Please choose a Multi-State data model');
return false;
}
}
// startingtreeonly
...
if (getValue('specify_runs_')) {
if (getValue('altrun_number_') > 1000) {
alert('Sorry, the value for alternative runs must 1000 or less');
return false;
}
}
// bipartitions
...
// ancestral_states
if (!getValue('bipartitions_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') &&!getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('log_likelihood_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_')) {
if (!getValue('bootstrap_seed_') && getValue('ancestral_states_') && ! getValue('treetop_')) {
alert('To use the -f A option you must specify a best tree with "-t"');
return false;
}
}
// log_likelihood
...
alert('To use the compute a log likelihood test option you must specify a best tree with "-t" and file containing multiple trees with the "-z" option');
return false;
}
}
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('bipartitions_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_')) {
if ((getValue('datatype_')=="dna" || getValue('datatype_')=="rna" ) && getValue('log_likelihood_') && getValue('dna_gtrcat_')) {
alert('Sorry, you cannot compute a log likelihood test with GTRCAT models, please use "GTRGAMMA for the bootstrapping phase and GTRGAMMA for the final tree"');
return false;
}
}
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('bipartitions_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_')) {
if (getValue('datatype_')=="protein" && getValue('log_likelihood_') && getValue('prot_sub_model_')=="PROTCAT") {
alert('Sorry, you cannot compute a log likelihood test with GTRCAT models, please select PROTGAMMA for the model');
return false;
}
}
if (!getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('startingtreeonly_') && !getValue('bipartitions_') && !getValue('compute_ml_distances_') && !getValue('specify_runs_')) {
if (getValue('datatype_')=="binary" && getValue('log_likelihood_') && getValue('bin_model_')=="BINCAT") {
alert('Sorry, you cannot compute a log likelihood test with GTRCAT models, please select BINGAMMA for the model');
return false;
}
}
// compute_mr
...
if ((getValue('bootstrap_seed_') || getValue('mulparambootstrap_seed_')) && !getValue('use_bootstopping_') && !getValue('startingtreeonly_')) {
if (getValue('bootstop_') > 5000) {
alert('Sorry, the value of bootstraps cannot exceed 5,000');
return false;
}
}
// use_bootstopping
...
if ((getValue('bootstrap_seed_') || getValue('mulparambootstrap_seed_')) && !getValue('specify_bootstraps_')) {
if (getValue('use_bootstopping_') && getValue('constraint_')) {
alert('Sorry, you can not use a constraint tree with automatic boot stopping');
return false;
}
}
// freq_bootstopping
...
// runtime
if (getValue('specify_bootstraps_') && getValue('bootstop_')< 50 && !getValue('more_memory_'))
{
...
if (getValue('specify_runs_') && !getValue('more_memory_'))
{
if (!confirm(messageSplit("The job will run on 32 processors as configured. If it runs for the entire configured time, it will consume 32 x getValue('runtime_') cpu hours")))
{
return false;
...
if (getValue('specify_bootstraps_') && getValue('bootstop_') >= 50 && !getValue('ancestral_states_') && !getValue('fast_tree_') && !getValue('bipartitions_') && !getValue('startingtreeonly_') && !getValue('log_likelihood_') && !getValue('more_memory_'))
{
...
if (getValue('use_bootstopping_') && !getValue('more_memory_'))
{
if (!confirm(messageSplit("The job will run on 64 processors as configured. If it runs for the entire configured time, it will consume 64 x getValue('runtime_') cpu hours")))
{
return false;
...
if (!getValue('mulparambootstrap_seed_') && !getValue('bootstrap_seed_') && !getValue('specify_runs_') && !getValue('more_memory_'))
{
if (!confirm(messageSplit("The job will run on 32 processors as configured. If it runs for the entire configured time, it will consume 32 x getValue('runtime_') cpu hours")))
{
return false;
...
// estimate_perpartbrlen
// invariable
if (getValue('invariable_'))
{
if (!confirm(messageSplit("The invariable option is not recommended by the developer of RAxML. Please see the manual for details.")))
{
return false;
}
}
...
// compute_ml_distances
// fast_tree
if (getValue('fast_tree_'))
{
if (!confirm(messageSplit("Any constraint trees will be ignored")))
{
return false;
}
}
...
var element = document.forms['raxmlhpc2_tgb'].elements[parameter];
if (element == null)
return null;
