...
<title>MrBayes 3.2.2 on XSEDE</title>
<h2>MrBayes 3.2.2 on XSEDE: Tree Inference Using Bayesian Analysis - run on XSEDE (<a href="#REFERENCE">John P. Huelsenbeck and Fred Ronquist</a>)</h2>
<s:form action="mrbayes_xsede" theme="simple">
...
<br/>
<A HREF="javascript:help.slidedownandjump('#flagdatatype')">My Data Type Is (only one data type can be used through the web form, see help below)</A>
<font color="red" size="3">*</font>
<s:select name="flagdatatype_" list="#{ 'dna':'nucleic acid' , 'protein':'protein' , 'standard':'standard' , 'other':'other' }" onchange="resolveParameters()"/>
<br/>
<br/>
<A HREF="javascript:help.slidedownandjump('#seed')">Set the Seed Number Set seed=</A>
<s:textfield name="seed_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#swapseed')">Set the Swapseed=</A>
<s:textfield name="swapseed_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#scientific')">Use scientific notation</A>
<s:checkbox name="scientific_" onclick="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#precision')">How many decimals should we print?</A>
<s:textfield name="precision_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#set_beagle_params')">Run BEAGLE</A>
<s:checkbox name="set_beagle_params_" onclick="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#set_outgroup')">Specify (only) one outgroup</A>
<s:textfield name="set_outgroup_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
</div>
</div>
...
<font color="red" size="3">+</font>
<s:select name="nstopts_" list="#{ '1':'1' , '2':'2' , '6':'6' , 'mixed':'mixed' }" onchange="resolveParameters()"/>
<br/>
<br/>
<A HREF="javascript:help.slidedownandjump('#nucmodelopts')">Set the nucleotide substitution model (Nucmodel=)</A>
<font color="red" size="3">+</font>
<s:select name="nucmodelopts_" list="#{ '4by4':'4 X 4' , 'doublet':'doublet' , 'codon':'codon' , 'protein':'protein' }" onchange="resolveParameters()"/>
<br/>
<br/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#ploidyopts')">Set the ploidy (Ploidy=)</A>
<font color="red" size="3">+</font>
<s:radio name="ploidyopts_"
list="#{ 'Diploid':'Diploid' , 'Haploid':'Haploid' , 'zlinked':'zlinked' }" onclick="resolveParameters()"/>
<br/>
...
<A HREF="javascript:help.slidedownandjump('#tratioopts')">Transition/Transversion Rate Ratio; DNA only (Tratiopr=)</A>
<font color="red" size="3">+</font>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#ny98omega3propts')">Nonsynonymous/Synonymous Rate Ratio for sites under positive selection (Ny98omega3pr=)</A>
<font color="red" size="3">+</font>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#M3omega3propts')">Nonsynonymous/Synonymous Rate Ratio for sites under the M3 model (M3omega1pr=)</A>
<font color="red" size="3">+</font>
<s:radio name="M3omega3propts_"
list="#{ 'exponential':'exponential' , 'fixed':'fixed' }" onclick="resolveParameters()"/>
<br/>
M3 Fixed Omega Rate 1 for M3 Model
<s:textfield name="M3omega3prfix1_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
M3 Fixed Omega Rate 2 for M3 Model
<s:textfield name="M3omega3prfix2_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
M3 Fixed Omega Rate 3 for M3 Model
<s:textfield name="M3omega3prfix3_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
...
list="#{ 'uniform':'uniform' , 'speciestree':'speciestree' , 'constraints':'constraints' }" onclick="resolveParameters()"/>
<br/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#treeheightpropts')">Distribution on Tree Height (for Clock Models) (Treeagepr=)</A>
<font color="red" size="3">+</font>
<s:radio name="treeheightpropts_"
list="#{ 'gamma':'gamma' , 'exponential':'exponential' , 'fixed':'fixed' }" onclick="resolveParameters()"/>
<br/>
Gamma Param 1
...
<br/>
Treeagepr Fixed Param
<s:textfield name="treeheightsprfx1_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#ratepropts')">Site Specific Rates Models (Ratepr=)</A>
<font color="red" size="3">+</font>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#sumt_relburnin')">Discard a specified proportion of samples instead of a specific number(Relburnin=Yes)</A>
<s:radio name="sumt_relburnin_"
list="#{ '': '[Not Mandatory]', 'Yes':'Yes' , 'No':'No' }" onclick="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#sumt_burninfrac')">Specify the fraction of samples to be discarded (Burninfrac=)</A>
<s:textfield name="sumt_burninfrac_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#sumt_conformat')">Choose the output format for your consensus tree (Conformat=)</A>
<s:radio name="sumt_conformat_"
list="#{ '': '[Not Mandatory]', 'Figtree':'Figtree' , 'Simple':'Simple' }" onclick="resolveParameters()"/>
<br/>
...
<br/>
<A HREF="javascript:help.slidedownandjump('#sump_relburnin')">Discard a specified proportion of samples instead of a specific number(Relburnin=Yes)</A>
<s:radio name="sump_relburnin_"
list="#{ '': '[Not Mandatory]', 'Yes':'Yes' , 'No':'No' }" onclick="resolveParameters()"/>
<br/>
<A HREF="javascript:help.slidedownandjump('#sump_burninfrac')">Specify the fraction of samples to be discarded (Burninfrac=)</A>
<s:textfield name="sump_burninfrac_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
...
<dt><a name=flagdatatype><i>My Data Type Is (only one data type can be used through the web form, see help below)</i></a></dt>
<dd>Setting this flag helps us eliminate uneeded options</dd>
<dt><a name=seed><i>Set the Seed Number Set seed=</i></a></dt>
...
<dt><a name=swapseed><i>Set the Swapseed=</i></a></dt>
...
<dt><a name=scientific><i>Use scientific notation</i></a></dt>
<dd>Write output in scientific notation (higher precision). Otherwise, use fixed format (easier for humans to read).
</dd>
<dt><a name=precision><i>How many decimals should we print?</i></a></dt>
<dd>Set the number of decimals to print your results in. Values of 3-15 are permitted.
</dd>
<dt><a name=set_beagle_params><i>Run BEAGLE</i></a></dt>
<dd>Beagle should speed up runs by about 10-20%. You should only disble this parameter if you have a problem using Beagle.</dd>
<dt><a name=set_outgroup><i>Specify (only) one outgroup</i></a></dt>
<dd>With this command, "outgroup 3" assigns the third taxon in the matrix to be the outgroup. Similarly, "outgroup Homo_sapiens" assings the taxon "Homo_sapiens" to be the outgroup (assuming that there is a taxon named "Homo_sapiens" in the matrix). Only a single taxon can be assigned to be the outgroup.
</dd>
<br></br>
...
<dt><a name=ploidyopts><i>Set the ploidy (Ploidy=)</i></a></dt>
<dd>This option is used when a coalescence prior is used on trees.
</dd>
...
<dt><a name=tratioopts><i>Transition/Transversion Rate Ratio; DNA only (Tratiopr=)</i></a></dt>
...
<dt><a name=ny98omega3propts><i>Nonsynonymous/Synonymous Rate Ratio for sites under positive selection (Ny98omega3pr=)</i></a></dt>
...
<dt><a name=M3omega3propts><i>Nonsynonymous/Synonymous Rate Ratio for sites under the M3 model (M3omega1pr=)</i></a></dt>
<dd>This parameter specifies the prior on the nonsynonymous/synonymous rate ratio for positively selected sites. The options are:uniform, exponential, and fixed. This parameter is only in effect if the nucleotide substitution model is set to codon and where omega varies across sites according to the NY98 model.
</dd>
...
<dt><a name=sumt_relburnin><i>Discard a specified proportion of samples instead of a specific number(Relburnin=Yes)</i></a></dt>
<dd> Specify the fraction of samples to be discarded.
</dd>
<dt><a name=sumt_burninfrac><i>Specify the fraction of samples to be discarded (Burninfrac=)</i></a></dt>
<dd> Specify the fraction of samples to be discarded.
</dd>
...
<dt><a name=sumt_conformat><i>Choose the output format for your consensus tree (Conformat=)</i></a></dt>
<dd> Figtree format is rich and can be read by the program Figtree. Simple format can be read by many programs
</dd>
<br></br>
...
<dt><a name=sump_relburnin><i>Discard a specified proportion of samples instead of a specific number(Relburnin=Yes)</i></a></dt>
<dd> Specify the fraction of samples to be discarded.
</dd>
<dt><a name=sump_burninfrac><i>Specify the fraction of samples to be discarded (Burninfrac=)</i></a></dt>
<dd> Specify the fraction of samples to be discarded.
</dd>
...
if (!getValue('mrbayesblockquery_'))
enable('scientific_');
else disable('scientific_');
// precision
if (!getValue('mrbayesblockquery_'))
enable('precision_');
else disable('precision_');
// set_beagle_params
// set_outgroup
if (!getValue('mrbayesblockquery_'))
enable('set_outgroup_');
else disable('set_outgroup_');
// nstopts
if (!getValue('mrbayesblockquery_'))
enable('nstopts_');
...
// ploidyopts
if (getValue('brlenspropts_')=="clock:coalescence")
enable('ploidyopts_');
else disable('ploidyopts_');
// rateopts
if (!getValue('mrbayesblockquery_'))
enable('rateopts_');
...
// tratioopts
if (!getValue('mrbayesblockquery_') && getValue('flagdatatype_')=="dna" )
enable('tratioopts_');
...
// M3omega3propts
if (!getValue('mrbayesblockquery_') && getValue('omegavaropts_')=="M3")
enable('M3omega3propts_');
else disable('M3omega3propts_');
// M3omega3prfix1
if (!getValue('mrbayesblockquery_') && getValue('M3omega3pr_')=="fixed")
enable('M3omega3prfix1_');
else disable('M3omega3prfix1_');
// M3omega3prfix2
if (!getValue('mrbayesblockquery_') && getValue('M3omega3pr_')=="fixed")
enable('M3omega3prfix2_');
else disable('M3omega3prfix2_');
// M3omega3prfix3
if (!getValue('mrbayesblockquery_') && getValue('M3omega3pr_')=="fixed")
enable('M3omega3prfix3_');
else disable('M3omega3prfix3_');
// codoncatfreqsopts
...
// treeheightpropts
if (!getValue('mrbayesblockquery_') && getValue('brlenspropts_')=="clock:uniform" )
...
// treeheightsprfx1
if (!getValue('mrbayesblockquery_') && getValue('treeheightpropts_')=="exponential")
enable('treeheightsprfx1_');
else disable('treeheightsprfx1_');
// ratepropts
if (!getValue('mrbayesblockquery_'))
enable('ratepropts_');
...
// extinctionpruni1
if ( !getValue('mrbayesblockquery_') && getValue('extinctionpropts_')=="beta")
...
// sumt_relburnin
if (!getValue('mrbayesblockquery_'))
enable('sumt_relburnin_');
else disable('sumt_relburnin_');
// sumt_burninfrac
if (!getValue('mrbayesblockquery_') && getValue('sumt_relburnin_')==Yes)
enable('sumt_burninfrac_');
else disable('sumt_burninfrac_');
// sumtnruns
if (!getValue('mrbayesblockquery_'))
enable('sumtnruns_');
...
// sumt_conformat
if (!getValue('mrbayesblockquery_'))
enable('sumt_conformat_');
else disable('sumt_conformat_');
// sumtshowtreeprobs
if (!getValue('mrbayesblockquery_'))
...
// sump_relburnin
if (!getValue('mrbayesblockquery_'))
enable('sump_relburnin_');
else disable('sump_relburnin_');
// sump_burninfrac
if (!getValue('mrbayesblockquery_') && getValue('sump_relburnin_')==Yes)
enable('sump_burninfrac_');
else disable('sump_burninfrac_');
// sumpnruns
if (!getValue('mrbayesblockquery_'))
enable('sumpnruns_');
...
alert('Please enter value for nruns');
return false;
}
}
if (getValue('mrbayesblockquery_')) {
...
// precision
if (!getValue('mrbayesblockquery_')) {
if (getValue('precision_') < 3) {
alert('Please set the precsion to a number between 3 and 15. 15 is the default.');
return false;
}
}
if (!getValue('mrbayesblockquery_')) {
if (getValue('precision_') > 15) {
alert('Please set the precsion to a number between 3 and 15. 15 is the default.');
return false;
}
}
...
// nrunsval
if (!getValue('mrbayesblockquery_')) {
if (! getValue('nrunsval_') ) {
alert('Please enter a value for nruns (default = 2)');
return false;
}
}
if (!getValue('mrbayesblockquery_')) {
if ((((getValue('nrunsval_') * getValue('nchainsval_')) % 2) != 0)) {
alert('nruns x nchains must be a multiple of 2');
return false;
}
}
if (!getValue('mrbayesblockquery_')) {
if ((getValue('nrunsval_') * getValue('nchainsval_') > 17) ) {
alert('nruns x nchains must be less than or equal to 16.');
return false;
}
}
...
alert('The value of nchains must 1 or greater. The default (recommended) is 4.');
return false;
}
}
if (!getValue('mrbayesblockquery_')) {
...
if (!getValue('mrbayesblockquery_')) {
if (! getValue('nchainsval_')) {
alert('Please enter a value for nchains= (default = 4)');
return false;
}
}
// tempval
...
// sumtburnin
if (!getValue('mrbayesblockquery_')) {
if (getValue('sumtburnin_') < 10) {
alert('Please enter a sumt burnin value of 10 or more');
return false;
}
}
// sumt_relburnin
...
// sumpburnin
if (!getValue('mrbayesblockquery_')) {
if (getValue('sumpburnin_') < 10) {
alert('Please enter a sump burnin value of 10 or more');
return false;
}
}
// sump_relburnin
...
// nruns_specified
// nchains_specified
if (getValue('mrbayesblockquery_') && getValue('nchains_specified_') * getValue('nruns_specified_') == 2)
{
...
if (getValue('mrbayesblockquery_') && getValue('nchains_specified_') * getValue('nruns_specified_') == 4)
{
...
if (getValue('mrbayesblockquery_') && getValue('nchains_specified_') * getValue('nruns_specified_') == 6)
{
...
if (getValue('mrbayesblockquery_') && getValue('nchains_specified_') * getValue('nruns_specified_') == 8)
{
...
// precision
// set_beagle_params
if (!getValue('set_beagle_params_'))
{
if (!confirm(messageSplit("Disabling BEAGLE will slow your run by as much as 20%. You should only do this if a run with BEAGLE fails")))
{
return false;
}
}
...
// excludeopts
// ngenval
if (getValue('ngenval_') > 50000 * getValue('samplefreqval_'))
{
if (!confirm(messageSplit("The number of samples you requested is greater than 50,000; this may cause your .t output file to exceed the allowed limit of 500 GB. Please consider editing your input file to request a lower sample frequency.")))
{
return false;
}
}
// nrunsval
if (!getValue('mrbayesblockquery_') && getValue('nchainsval_') * getValue('nrunsval_') == 2)
{
if (!confirm(messageSplit("The job will run on 2 processors as configured. If it runs for the entire configured time, it will consume 2 x getValue('runtime_') cpu hours")))
{
return false;
...
if (!getValue('mrbayesblockquery_') && getValue('nchainsval_') * getValue('nrunsval_') == 4)
{
if (!confirm(messageSplit("The job will run on 4 processors as configured. If it runs for the entire configured time, it will consume 4 x getValue('runtime_') cpu hours")))
{
return false;
...
if (!getValue('mrbayesblockquery_') && getValue('nchainsval_') * getValue('nrunsval_') == 6)
{
if (!confirm(messageSplit("The job will run on 6 processors as configured. If it runs for the entire configured time, it will consume 6 x getValue('runtime_') cpu hours")))
{
return false;
...
if (!getValue('mrbayesblockquery_') && getValue('nchainsval_') * getValue('nrunsval_') == 8)
{
if (!confirm(messageSplit("The job will run on 8 processors as configured. If it runs for the entire configured time, it will consume 8 x getValue('runtime_') cpu hours")))
{
return false;
...
var element = document.forms['mrbayes_xsede'].elements[parameter];
if (element == null)
return null;
