...
<title>Align</title>
<h2>Align: Compute the global alignment of two DNA or Protein Sequences (<a href="#REFERENCE">W. Pearson</a>)</h2>
<s:form action="align" theme="simple">
<!-- Begin Simple Parameters -->
<a href="javascript:simple.slideit()" class="panel">Simple Parameters</a>
<div id="simple" style="width: 100%; background-color: #FFF;">
<div style="padding: 0.75em 0 0 0">
Query Sequence 2 File
...
var element = document.forms['align'].elements[parameter];
if (element == null)
return null;
