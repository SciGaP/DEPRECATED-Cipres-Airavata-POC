...
<title>Pepinfo</title>
<h2>Pepinfo: Plots simple amino acid properties </h2>
<s:form action="pepinfo" theme="simple">
...
<s:textfield name="hwindow_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
User defined amino acid properties filename (-aaproperties)
<font color="red" size="3">*</font>
<s:textfield name="aaproperties_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
User defined hydropathy data filename (-aahydropathy)
<font color="red" size="3">*</font>
<s:textfield name="aahydropathy_" size="10" maxlength="600" onchange="resolveParameters()"/>
<br/>
<hr/>
...
<font color="red" size="3">*</font>
<s:checkbox name="generalplot_" onclick="resolveParameters()"/>
<br/>
plot graphs of hydropathy (-hydropathyplot)
<font color="red" size="3">*</font>
<s:checkbox name="hydropathyplot_" onclick="resolveParameters()"/>
<br/>
</div>
</div>
<script type="text/javascript">
...
var element = document.forms['pepinfo'].elements[parameter];
if (element == null)
return null;
