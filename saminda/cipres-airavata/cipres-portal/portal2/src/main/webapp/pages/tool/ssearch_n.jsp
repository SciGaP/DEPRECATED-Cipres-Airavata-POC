...
<title>SSearch_N</title>
<h2>SSearch_N: NS database similarity search (<a href="#REFERENCE">W. Pearson</a>)</h2>
<s:form action="ssearch_n" theme="simple">
...
var element = document.forms['ssearch_n'].elements[parameter];
if (element == null)
return null;
