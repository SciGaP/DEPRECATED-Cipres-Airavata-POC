...
<title>TBlastN</title>
<h2>TBlastN: Compare a PS to translated NS DB (<a href="#REFERENCE">Altschul, Madden, Schaeffer, Zhang, Miller, Lipman</a>)</h2>
<s:form action="tblastn" theme="simple">
...
list="#{ 'tblastn':'tblastn: protein query / translated nucleotide db' }" onclick="resolveParameters()"/>
<br/>
...
<dd>tblastn compares a protein query sequence against a nucleotide sequence database dynamically translated in all six reading frames (both strands)</dd>
...
<dd>Useful for genomes searching, where there is only one sequence in the database.</dd>
...
var element = document.forms['tblastn'].elements[parameter];
if (element == null)
return null;
