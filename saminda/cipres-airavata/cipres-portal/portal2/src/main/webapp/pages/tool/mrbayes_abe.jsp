...
<s:form action="mrbayes_abe" theme="simple">
...
<dd>
Estimate the maximum time your job will need to run (between 48 - 168hrs, or < 0.5hr for a test run).
Your job will be killed if it doesn't finish within the time you specify, however jobs with
shorter maximum run times often run sooner than longer jobs. Jobs that need less than 48 hrs
cannot be run on ABE, but should be run on Lonestar instead.
</dd>
<br></br>
...
alert('The value for nruns must 1 or greater. The default value is 2.');
return false;
}
}
// nchains_specified
...
alert('The value for nchains must be 1 or greater. The default value is 4.');
return false;
}
}
// runtime
if (( getValue('runtime_') < 48.0 && getValue('runtime_') >= .5 ) || getValue('runtime_') > 168.0) {
alert('The maximum hours to run must be a value between 48 - 168, or you can submit a test run of less than 0.5 hr');
return false;
}
// usertreesel
// Usertreeopt
...
var element = document.forms['mrbayes_abe'].elements[parameter];
if (element == null)
return null;
