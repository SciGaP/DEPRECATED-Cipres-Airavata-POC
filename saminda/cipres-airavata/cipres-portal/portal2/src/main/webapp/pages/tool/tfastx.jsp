...
<title>TFastX</title>
<h2>TFastX: Compare PS to Translated NS Or NS-DB (<a href="#REFERENCE">W. Pearson</a>)</h2>
<s:form action="tfastx" theme="simple">
...
<font color="red" size="3">*</font>
<s:radio name="fasta_"
list="#{ 'tfastx':'tfastx: protein query vs translated DNA db (frameshifts only between codons)' }" onclick="resolveParameters()"/>
<br/>
...
<dd>. tfastx/tfasty - compare a protein sequence vs a translated DNA db, with frameshifts.
tfasty allows frameshifts inside codons.</dd>
<br></br>
...
search, low complexity regions will not produce statistical significant matches.</dd><dd>If a significant alignment contains low complexity regions the final score may be higher than the score
...
var element = document.forms['tfastx'].elements[parameter];
if (element == null)
return null;
