...
<title>GARLI on Abe</title>
<h2>GARLI on Abe: Genetic Algorithm for Rapid Likelihood Inference - run on teragrid. (<a href="#REFERENCE">Derrick J. Zwickl (zwickl@nescent.org)</a>)</h2>
<s:form action="garli_abe" theme="simple">
...
<font color="red" size="3">+</font>
<s:select name="bootstrapreps_" list="#{ '0':'0' , '8':'8' , '16':'16' , '24':'24' , '32':'32' , '40':'40' , '48':'48' , '56':'56' , '64':'64' , '72':'72' , '80':'80' , '88':'88' , '96':'96' , '100':'100' }" onchange="resolveParameters()"/>
<br/>
<br/>
...
var element = document.forms['garli_abe'].elements[parameter];
if (element == null)
return null;
