usage.sh
	...
	4. cds to ~/scripts uses usage.py to send overlimit warning emails to users. It does
	the cd because mailer.py looks for the allocation_message?.txt files in the current directory.
