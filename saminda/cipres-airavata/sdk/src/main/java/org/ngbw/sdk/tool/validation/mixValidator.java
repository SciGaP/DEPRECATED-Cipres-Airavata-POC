...
public class mixValidator implements ParameterValidator2
{
...
allowedParameters.add("use_mixed_");
switchValues.put("use_mixed_", switchList);
allowedInput.add("mixture_file_");
tmpList = new ArrayList<String>();
tmpList.add("wagner");
tmpList.add("camin");
exclValues.put("parsimony_method_", tmpList);
allowedParameters.add("parsimony_method_");
