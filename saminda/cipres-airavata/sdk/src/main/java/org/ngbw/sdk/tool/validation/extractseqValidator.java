...
public class extractseqValidator implements ParameterValidator2
{
...
allowedParameters.add("upload_rangefile_");
switchValues.put("upload_rangefile_", switchList);
allowedInput.add("input_rangefile_");
allowedParameters.add("write_separate_");
switchValues.put("write_separate_", switchList);
