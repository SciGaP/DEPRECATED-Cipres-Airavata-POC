...
public class fingerprintscanValidator implements ParameterValidator2
{
...
allowedParameters.add("motif_");
allowedParameters.add("threshold_");
allowedParameters.add("graph_scan_");
switchValues.put("graph_scan_", switchList);
allowedParameters.add("number_bits_");
allowedParameters.add("random_shuffle_");
switchValues.put("random_shuffle_", switchList);
allowedParameters.add("profile_score_");
allowedParameters.add("p_value_");
}
