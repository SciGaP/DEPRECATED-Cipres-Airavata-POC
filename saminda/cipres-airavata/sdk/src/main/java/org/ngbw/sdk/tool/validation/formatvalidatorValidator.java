...
public class formatvalidatorValidator implements ParameterValidator2
{
...
public formatvalidatorValidator() {
...
tmpList.add("-fnexus");
tmpList.add("-faafasta");
tmpList.add("-fdnafasta");
tmpList.add("-frnafasta");
tmpList.add("-fdnaphylip");
tmpList.add("-frnaphylip");
tmpList.add("-faaphylip");
tmpList.add("-fdiscretephylip");
tmpList.add("-fdnaphylipinterleaved");
tmpList.add("-frnaphylipinterleaved");
tmpList.add("-faaphylipinterleaved");
tmpList.add("-fdiscretephylipinterleaved");
tmpList.add("-fdnarelaxedphylip");
tmpList.add("-frnarelaxedphylip");
tmpList.add("-faarelaxedphylip");
tmpList.add("-fdiscreterelaxedphylip");
tmpList.add("-fdnarelaxedphylipinterleaved");
tmpList.add("-frnarelaxedphylipinterleaved");
tmpList.add("-faarelaxedphylipinterleaved");
tmpList.add("-fdiscreterelaxedphylipinterleaved");
exclValues.put("setnexusformat_", tmpList);
allowedParameters.add("setnexusformat_");
requiredParameters.add("setnexusformat_");
tmpList = new ArrayList<String>();
tmpList.add("-s0");
tmpList.add("-s1");
tmpList.add("-s2");
tmpList.add("-s3");
tmpList.add("-s4");
exclValues.put("setnexuscontrol_", tmpList);
allowedParameters.add("setnexuscontrol_");
requiredParameters.add("setnexuscontrol_");
}
...
if (parameter.equals("setnexusformat_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
if (parameter.equals("setnexuscontrol_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
