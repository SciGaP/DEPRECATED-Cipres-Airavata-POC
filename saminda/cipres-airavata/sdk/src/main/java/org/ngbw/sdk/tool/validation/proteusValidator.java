...
public class proteusValidator implements ParameterValidator2
{
...
requiredParameters.add("analysis_type_");
allowedParameters.add("transmembrane_only_");
switchValues.put("transmembrane_only_", switchList);
tmpList = new ArrayList<String>();
tmpList.add("1");
tmpList.add("2");
tmpList.add("3");
exclValues.put("signalpeptide_org_", tmpList);
allowedParameters.add("signalpeptide_org_");
allowedParameters.add("is_verbose_");
switchValues.put("is_verbose_", switchList);
allowedParameters.add("use_homology_");
switchValues.put("use_homology_", switchList);
allowedParameters.add("energy_min_");
switchValues.put("energy_min_", switchList);
}
...
if (parameter.equals("analysis_type_")) {
