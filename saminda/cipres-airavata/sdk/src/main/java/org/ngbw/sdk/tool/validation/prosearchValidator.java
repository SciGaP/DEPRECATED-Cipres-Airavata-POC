...
public class prosearchValidator implements ParameterValidator2
{
...
switchList.add("1");
List<String> tmpList;
allowedInput.add("protein_");
requiredInput.add("protein_");
allowedParameters.add("sites_");
switchValues.put("sites_", switchList);
allowedParameters.add("doc_");
switchValues.put("doc_", switchList);
}
