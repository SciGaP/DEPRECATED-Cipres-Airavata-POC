...
public class mrbayeshybrid_abeValidator implements ParameterValidator2
{
...
public mrbayeshybrid_abeValidator() {
...
allowedParameters.add("nchar_specified_");
allowedParameters.add("is_partitioned_");
switchValues.put("is_partitioned_", switchList);
allowedParameters.add("is_partitioned_notproteindna_");
switchValues.put("is_partitioned_notproteindna_", switchList);
...
if (parameter.equals("nchar_specified_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
