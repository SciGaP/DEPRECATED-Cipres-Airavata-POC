...
public class nclconverterValidator implements ParameterValidator2
{
...
tmpList.add("clustal");
tmpList.add("nexml");
exclValues.put("format_type_", tmpList);
allowedParameters.add("format_type_");
requiredParameters.add("format_type_");
tmpList = new ArrayList<String>();
tmpList.add("dna");
tmpList.add("rna");
tmpList.add("protein");
...
allowedParameters.add("relaxed_type_");
switchValues.put("relaxed_type_", switchList);
allowedParameters.add("interleaved_type_");
switchValues.put("interleaved_type_", switchList);
allowedParameters.add("nexus_strictness_");
tmpList = new ArrayList<String>();
tmpList.add("-enexus");
tmpList.add("-efasta");
tmpList.add("-ephylip");
tmpList.add("-erelaxedphylip");
tmpList.add("-enexml");
exclValues.put("output_type_", tmpList);
allowedParameters.add("output_type_");
requiredParameters.add("output_type_");
allowedParameters.add("outfile_nexus_");
}
...
if (parameter.equals("format_type_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
if (parameter.equals("nexus_strictness_")) {
