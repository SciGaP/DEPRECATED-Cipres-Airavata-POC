...
public class cliqueValidator implements ParameterValidator2
{
...
allowedParameters.add("use_ancestral_state_");
switchValues.put("use_ancestral_state_", switchList);
allowedInput.add("ancestral_state_file_");
allowedParameters.add("spec_min_clique_size_");
switchValues.put("spec_min_clique_size_", switchList);
allowedParameters.add("min_clique_size_");
...
allowedParameters.add("print_matrix_");
switchValues.put("print_matrix_", switchList);
...
if (parameter.equals("min_clique_size_")) {
