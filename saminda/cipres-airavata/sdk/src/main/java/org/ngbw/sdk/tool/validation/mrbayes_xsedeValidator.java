...
public class mrbayes_xsedeValidator implements ParameterValidator2
{
...
tmpList.add("other");
exclValues.put("flagdatatype_", tmpList);
allowedParameters.add("flagdatatype_");
requiredParameters.add("flagdatatype_");
allowedParameters.add("seed_");
allowedParameters.add("swapseed_");
allowedParameters.add("scientific_");
switchValues.put("scientific_", switchList);
allowedParameters.add("precision_");
allowedParameters.add("set_beagle_params_");
switchValues.put("set_beagle_params_", switchList);
...
tmpList.add("Haploid");
tmpList.add("zlinked");
exclValues.put("ploidyopts_", tmpList);
allowedParameters.add("ploidyopts_");
tmpList = new ArrayList<String>();
tmpList.add("equal");
tmpList.add("gamma");
tmpList.add("adgamma");
...
tmpList.add("exponential");
tmpList.add("fixed");
exclValues.put("M3omega3propts_", tmpList);
allowedParameters.add("M3omega3propts_");
allowedParameters.add("M3omega3prfix1_");
allowedParameters.add("M3omega3prfix2_");
allowedParameters.add("M3omega3prfix3_");
tmpList = new ArrayList<String>();
tmpList.add("dirichlet");
tmpList.add("fixed");
...
allowedParameters.add("treeheightsprfx1_");
tmpList = new ArrayList<String>();
tmpList.add("fixed");
tmpList.add("variable");
...
tmpList.add("Yes");
tmpList.add("No");
exclValues.put("sumt_relburnin_", tmpList);
allowedParameters.add("sumt_relburnin_");
allowedParameters.add("sumt_burninfrac_");
...
tmpList.add("Figtree");
tmpList.add("Simple");
exclValues.put("sumt_conformat_", tmpList);
allowedParameters.add("sumt_conformat_");
tmpList = new ArrayList<String>();
...
tmpList.add("Yes");
tmpList.add("No");
exclValues.put("sump_relburnin_", tmpList);
allowedParameters.add("sump_relburnin_");
allowedParameters.add("sump_burninfrac_");
...
if (parameter.equals("flagdatatype_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
...
if (parameter.equals("precision_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
...
if (parameter.equals("M3omega3prfix1_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("M3omega3prfix2_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("M3omega3prfix3_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
...
if (parameter.equals("treeheightsprfx1_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
...
if (parameter.equals("sumt_burninfrac_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
...
if (parameter.equals("sump_burninfrac_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
