...
public class poy2Validator implements ParameterValidator2
{
...
allowedInput.add("infile1_");
requiredInput.add("infile1_");
allowedInput.add("infile2_");
allowedInput.add("infile3_");
allowedInput.add("infile4_");
allowedInput.add("infile5_");
allowedInput.add("infile6_");
allowedParameters.add("substitutions_");
requiredParameters.add("substitutions_");
allowedParameters.add("indels_");
requiredParameters.add("indels_");
allowedParameters.add("gapopening_");
requiredParameters.add("gapopening_");
allowedInput.add("terminalsfile_");
allowedInput.add("synonyms_");
allowedParameters.add("outgroup_");
allowedInput.add("constraint_");
allowedParameters.add("randomseed_");
tmpList = new ArrayList<String>();
tmpList.add("bremer");
tmpList.add("jackknife");
tmpList.add("bootstrap");
exclValues.put("support_", tmpList);
allowedParameters.add("support_");
allowedParameters.add("pseudoreplicates_");
allowedParameters.add("remove_");
}
...
if (parameter.equals("substitutions_")) {
...
if (parameter.equals("gapopening_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
...
if (parameter.equals("randomseed_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("pseudoreplicates_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("remove_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
