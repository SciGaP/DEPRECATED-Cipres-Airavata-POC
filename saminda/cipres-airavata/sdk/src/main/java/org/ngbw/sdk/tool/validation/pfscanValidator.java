...
public class pfscanValidator implements ParameterValidator2
{
...
allowedParameters.add("prosite_");
switchValues.put("prosite_", switchList);
allowedInput.add("profiledb_");
allowedParameters.add("pfscan_cutoff_");
...
if (parameter.equals("pfscan_cutoff_")) {
