...
public class probalignValidator implements ParameterValidator2
{
...
allowedParameters.add("alignment_order_");
switchValues.put("alignment_order_", switchList);
tmpList = new ArrayList<String>();
tmpList.add("gonnet_160");
tmpList.add("nuc_simple");
exclValues.put("scoring_matrix_", tmpList);
allowedParameters.add("scoring_matrix_");
requiredParameters.add("scoring_matrix_");
allowedParameters.add("output_format_");
switchValues.put("output_format_", switchList);
allowedParameters.add("gapopenn_");
allowedParameters.add("gapextn_");
allowedParameters.add("temp_na_");
allowedParameters.add("gapopenp_");
allowedParameters.add("gapextp_");
allowedParameters.add("temp_aa_");
}
...
if (parameter.equals("scoring_matrix_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
if (parameter.equals("gapopenn_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("gapextn_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("temp_na_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("gapopenp_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("gapextp_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("temp_aa_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
