...
public class helixturnhelixValidator implements ParameterValidator2
{
...
allowedParameters.add("mean_");
allowedParameters.add("sd_");
allowedParameters.add("minsd_");
allowedParameters.add("eightyseven_");
switchValues.put("eightyseven_", switchList);
}
...
return "Must be a Double within the range " + "1. to 10000.";
if (BaseValidator.validateDoubleMaxValue(value, 10000.) == false)
return "Must be a Double less than " + "or equal to 10000.";
return null;
}
...
return "Must be a Double within the range " + "0. to 100.";
if (BaseValidator.validateDoubleMaxValue(value, 100.) == false)
return "Must be a Double less than " + "or equal to 100.";
return null;
}
return null;
}
