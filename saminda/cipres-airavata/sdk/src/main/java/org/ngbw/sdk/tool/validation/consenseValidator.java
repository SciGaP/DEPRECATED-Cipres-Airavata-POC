...
public class consenseValidator implements ParameterValidator2
{
...
tmpList.add("MR");
tmpList.add("ML");
exclValues.put("type_", tmpList);
allowedParameters.add("type_");
...
allowedParameters.add("rooted_");
switchValues.put("rooted_", switchList);
}
