...
public class dnaparsValidator implements ParameterValidator2
{
...
allowedParameters.add("numtrees_");
tmpList = new ArrayList<String>();
tmpList.add("0");
tmpList.add("1");
tmpList.add("2");
...
requiredParameters.add("search_opt_");
allowedParameters.add("use_threshold_");
switchValues.put("use_threshold_", switchList);
allowedParameters.add("threshold_");
allowedParameters.add("use_transversion_");
switchValues.put("use_transversion_", switchList);
...
if (parameter.equals("numtrees_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("search_opt_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
