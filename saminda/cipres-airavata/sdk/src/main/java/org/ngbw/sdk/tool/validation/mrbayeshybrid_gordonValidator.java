...
public class mrbayeshybrid_gordonValidator implements ParameterValidator2
{
...
public mrbayeshybrid_gordonValidator() {
...
allowedParameters.add("ngen_specified_");
allowedParameters.add("sample_freq_");
