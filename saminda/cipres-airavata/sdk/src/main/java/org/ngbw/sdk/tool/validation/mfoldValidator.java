...
public class mfoldValidator implements ParameterValidator2
{
...
switchList.add("1");
List<String> tmpList;
allowedInput.add("SEQ_");
requiredInput.add("SEQ_");
tmpList = new ArrayList<String>();
tmpList.add("linear");
tmpList.add("circular");
exclValues.put("LC_", tmpList);
allowedParameters.add("LC_");
tmpList = new ArrayList<String>();
tmpList.add("RNA");
tmpList.add("DNA");
exclValues.put("NA_", tmpList);
allowedParameters.add("NA_");
allowedParameters.add("T_");
allowedParameters.add("P_");
allowedParameters.add("NA_CONC_");
allowedParameters.add("MG_CONC_");
allowedParameters.add("W_");
allowedParameters.add("MAXBP_");
allowedParameters.add("MAX_");
tmpList = new ArrayList<String>();
tmpList.add("none");
tmpList.add("p-num");
tmpList.add("ss-count");
exclValues.put("ANN_", tmpList);
allowedParameters.add("ANN_");
tmpList = new ArrayList<String>();
tmpList.add("auto");
tmpList.add("bases");
tmpList.add("lines");
exclValues.put("MODE_", tmpList);
allowedParameters.add("MODE_");
allowedParameters.add("ROT_ANG_");
allowedParameters.add("START_");
allowedParameters.add("STOP_");
}
...
if (parameter.equals("T_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("P_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("NA_CONC_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("MG_CONC_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("W_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("MAXBP_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
...
if (parameter.equals("ROT_ANG_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("START_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("STOP_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
