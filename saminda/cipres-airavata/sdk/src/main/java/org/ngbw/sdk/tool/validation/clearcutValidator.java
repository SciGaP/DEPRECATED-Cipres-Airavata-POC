...
public class clearcutValidator implements ParameterValidator2
{
...
allowedParameters.add("alignment_or_");
switchValues.put("alignment_or_", switchList);
tmpList = new ArrayList<String>();
tmpList.add("DNA");
tmpList.add("protein");
exclValues.put("datatype_is_", tmpList);
allowedParameters.add("datatype_is_");
tmpList = new ArrayList<String>();
tmpList.add("");
tmpList.add("--jukes");
tmpList.add("--kimura");
exclValues.put("corr_model_", tmpList);
allowedParameters.add("corr_model_");
allowedParameters.add("use_trad_");
switchValues.put("use_trad_", switchList);
allowedParameters.add("shuff_matrix_");
switchValues.put("shuff_matrix_", switchList);
allowedParameters.add("join_det_");
switchValues.put("join_det_", switchList);
allowedParameters.add("spec_seed_");
switchValues.put("spec_seed_", switchList);
allowedParameters.add("seed_val_");
allowedParameters.add("matrix_out_");
switchValues.put("matrix_out_", switchList);
allowedParameters.add("ntrees_out_");
allowedParameters.add("exp_dist_");
switchValues.put("exp_dist_", switchList);
allowedParameters.add("exp_brl_");
switchValues.put("exp_brl_", switchList);
}
...
if (parameter.equals("seed_val_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("ntrees_out_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
