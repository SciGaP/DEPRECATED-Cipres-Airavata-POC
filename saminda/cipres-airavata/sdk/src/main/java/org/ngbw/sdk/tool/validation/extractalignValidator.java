...
public class extractalignValidator implements ParameterValidator2
{
...
allowedParameters.add("regions_option_");
requiredParameters.add("regions_option_");
...
if (parameter.equals("regions_option_")) {
