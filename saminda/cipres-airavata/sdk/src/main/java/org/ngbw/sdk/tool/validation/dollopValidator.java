...
public class dollopValidator implements ParameterValidator2
{
...
allowedParameters.add("dollop_method_");
switchValues.put("dollop_method_", switchList);
...
allowedParameters.add("tree_jumble_seed_");
...
if (parameter.equals("tree_jumble_seed_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
