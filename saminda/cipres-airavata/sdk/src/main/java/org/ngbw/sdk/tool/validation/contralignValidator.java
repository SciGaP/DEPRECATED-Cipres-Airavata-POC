...
public class contralignValidator implements ParameterValidator2
{
...
allowedParameters.add("outputMFA_");
switchValues.put("outputMFA_", switchList);
allowedParameters.add("outputClustal_");
switchValues.put("outputClustal_", switchList);
allowedParameters.add("gamma_");
allowedParameters.add("annealing_");
switchValues.put("annealing_", switchList);
allowedParameters.add("pc_iters_");
allowedParameters.add("sc_iters_");
allowedInput.add("paramsFile_");
allowedParameters.add("partition_");
switchValues.put("partition_", switchList);
}
...
if (parameter.equals("gamma_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("pc_iters_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("sc_iters_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
