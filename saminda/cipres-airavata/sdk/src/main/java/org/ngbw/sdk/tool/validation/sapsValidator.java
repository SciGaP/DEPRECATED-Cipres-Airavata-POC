...
public class sapsValidator implements ParameterValidator2
{
...
allowedParameters.add("documented_");
switchValues.put("documented_", switchList);
allowedParameters.add("terse_");
switchValues.put("terse_", switchList);
allowedParameters.add("verbose_");
switchValues.put("verbose_", switchList);
allowedParameters.add("table_");
switchValues.put("table_", switchList);
...
tmpList.add("XENLA");
tmpList.add("swp23s");
exclValues.put("specie_", tmpList);
allowedParameters.add("specie_");
allowedParameters.add("H_positive_");
switchValues.put("H_positive_", switchList);
allowedParameters.add("analyze_");
}
