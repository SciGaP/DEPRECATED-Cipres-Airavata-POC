...
public class beast_tg_testValidator implements ParameterValidator2
{
...
allowedParameters.add("nu_partitions_");
allowedParameters.add("no_beagle_");
switchValues.put("no_beagle_", switchList);
...
tmpList.add("dynamic");
tmpList.add("none");
exclValues.put("beagle_scaling_", tmpList);
allowedParameters.add("beagle_scaling_");
}
...
if (parameter.equals("nu_partitions_")) {
