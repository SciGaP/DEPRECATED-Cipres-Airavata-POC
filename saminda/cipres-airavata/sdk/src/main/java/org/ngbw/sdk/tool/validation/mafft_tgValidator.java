...
public class mafft_tgValidator implements ParameterValidator2
{
...
tmpList = new ArrayList<String>();
tmpList.add("fftnsi2");
tmpList.add("fftnsi1000");
tmpList.add("fftns168");
tmpList.add("fftns268");
tmpList.add("nwnsi68");
tmpList.add("nwns268");
tmpList.add("nwns268part");
...
allowedParameters.add("use_seed_");
switchValues.put("use_seed_", switchList);
allowedInput.add("seed_alignment1_");
allowedParameters.add("use_add_");
switchValues.put("use_add_", switchList);
allowedInput.add("add_alignment1_");
allowedParameters.add("use_addfrag_");
switchValues.put("use_addfrag_", switchList);
allowedParameters.add("large_align_");
switchValues.put("large_align_", switchList);
allowedInput.add("ref_alignment1_");
allowedParameters.add("reorder_add_");
switchValues.put("reorder_add_", switchList);
allowedParameters.add("use_addprof_");
switchValues.put("use_addprof_", switchList);
allowedInput.add("existing_alignment1_");
allowedParameters.add("use_merge_");
switchValues.put("use_merge_", switchList);
allowedInput.add("submsa_table_");
allowedInput.add("treein_tree_");
tmpList = new ArrayList<String>();
tmpList.add("200");
tmpList.add("20");
tmpList.add("1");
