...
public class pepwindowValidator implements ParameterValidator2
{
...
tmpList.add("null");
tmpList.add("data");
tmpList.add("colourps");
tmpList.add("text");
tmpList.add("none");
tmpList.add("tek4107t");
tmpList.add("tekt");
tmpList.add("xwindows");
tmpList.add("hpgl");
tmpList.add("xterm");
tmpList.add("meta");
tmpList.add("ps");
tmpList.add("tek");
tmpList.add("png");
tmpList.add("tektronics");
exclValues.put("graph_", tmpList);
allowedParameters.add("graph_");
}
...
if (BaseValidator.validateIntegerValueRange(value, 1, 200) == false)
return "Must be an integer within the range " +
"1 to 200";
if (BaseValidator.validateIntegerMaxValue(value, 200) == false)
return "Must be an integer less than " + "or equal to 200";
return null;
}
return null;
}
