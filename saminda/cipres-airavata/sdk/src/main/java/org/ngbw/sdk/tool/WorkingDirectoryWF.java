 ...
 *
 */
public class WorkingDirectoryWF implements WorkingDirectory
{
	private static final Log log = LogFactory.getLog(WorkingDirectoryWF.class);
	protected final ServiceFactory m_serviceFactory;
	protected final Task task;

	public WorkingDirectoryWF(ServiceFactory serviceFactory, Task task)
	{
