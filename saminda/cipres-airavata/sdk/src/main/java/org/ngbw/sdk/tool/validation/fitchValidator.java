...
public class fitchValidator implements ParameterValidator2
{
...
allowedParameters.add("negative_branch_");
switchValues.put("negative_branch_", switchList);
allowedParameters.add("power_");
...
allowedParameters.add("multiple_seed_");
allowedParameters.add("user_tree_");
switchValues.put("user_tree_", switchList);
allowedInput.add("tree_file_");
allowedParameters.add("use_lengths_");
switchValues.put("use_lengths_", switchList);
...
tmpList.add("lower");
tmpList.add("upper");
exclValues.put("triangular_", tmpList);
allowedParameters.add("triangular_");
allowedParameters.add("global_");
switchValues.put("global_", switchList);
}
