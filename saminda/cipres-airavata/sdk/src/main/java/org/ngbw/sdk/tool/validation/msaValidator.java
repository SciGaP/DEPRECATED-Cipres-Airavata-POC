...
public class msaValidator implements ParameterValidator2
{
...
switchList.add("1");
List<String> tmpList;
allowedInput.add("seqs_");
requiredInput.add("seqs_");
allowedParameters.add("optimal_");
switchValues.put("optimal_", switchList);
allowedInput.add("forcedres_");
allowedParameters.add("endgap_");
switchValues.put("endgap_", switchList);
allowedParameters.add("unweight_");
switchValues.put("unweight_", switchList);
allowedParameters.add("maxscore_");
allowedInput.add("epsilons_");
allowedInput.add("costs_");
allowedParameters.add("quiet_");
switchValues.put("quiet_", switchList);
}
