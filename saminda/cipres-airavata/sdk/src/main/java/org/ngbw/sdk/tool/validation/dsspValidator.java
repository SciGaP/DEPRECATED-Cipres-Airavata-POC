...
public class dsspValidator implements ParameterValidator2
{
...
switchList.add("1");
List<String> tmpList;
allowedInput.add("pdbfile_");
requiredInput.add("pdbfile_");
allowedParameters.add("surface_");
switchValues.put("surface_", switchList);
allowedParameters.add("classic_");
switchValues.put("classic_", switchList);
}
