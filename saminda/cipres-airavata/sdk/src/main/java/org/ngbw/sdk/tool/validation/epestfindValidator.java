...
public class epestfindValidator implements ParameterValidator2
{
...
switchList.add("1");
List<String> tmpList;
allowedInput.add("seq_file_");
requiredInput.add("seq_file_");
allowedParameters.add("min_dist_");
allowedParameters.add("threshold_value_");
allowedParameters.add("usemy_aadata_");
switchValues.put("usemy_aadata_", switchList);
allowedInput.add("my_aadata_upload_");
allowedParameters.add("no_potential_");
switchValues.put("no_potential_", switchList);
allowedParameters.add("no_poor_");
switchValues.put("no_poor_", switchList);
allowedParameters.add("no_invalid_");
switchValues.put("no_invalid_", switchList);
allowedParameters.add("no_map_");
switchValues.put("no_map_", switchList);
allowedParameters.add("sbegin1_");
allowedParameters.add("send1_");
tmpList = new ArrayList<String>();
tmpList.add("length");
tmpList.add("position");
tmpList.add("score");
exclValues.put("sort_order_", tmpList);
allowedParameters.add("sort_order_");
requiredParameters.add("sort_order_");
tmpList = new ArrayList<String>();
tmpList.add("postscript");
tmpList.add("png");
tmpList.add("none");
exclValues.put("graph_type_", tmpList);
allowedParameters.add("graph_type_");
requiredParameters.add("graph_type_");
allowedParameters.add("gsubtitle_input_");
}
...
if (parameter.equals("min_dist_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("threshold_value_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("sbegin1_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("send1_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("sort_order_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
if (parameter.equals("graph_type_")) {
if (BaseValidator.validateString(value) == false)
return "Parameter is required.";
return null;
}
