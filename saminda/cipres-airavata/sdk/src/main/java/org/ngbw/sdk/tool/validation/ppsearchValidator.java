...
public class ppsearchValidator implements ParameterValidator2
{
...
switchList.add("1");
List<String> tmpList;
allowedInput.add("inputfile_");
requiredInput.add("inputfile_");
allowedParameters.add("abundant_patterns_");
switchValues.put("abundant_patterns_", switchList);
}
