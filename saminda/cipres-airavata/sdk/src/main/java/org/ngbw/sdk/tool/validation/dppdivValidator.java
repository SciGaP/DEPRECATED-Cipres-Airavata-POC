...
public class dppdivValidator implements ParameterValidator2
{
...
allowedInput.add("upload_treefile_");
requiredInput.add("upload_treefile_");
allowedParameters.add("mcmc_cycles_");
allowedParameters.add("print_freq_");
allowedParameters.add("sample_frequency_");
allowedParameters.add("outfile_prefix_");
allowedParameters.add("prior_mean_");
allowedParameters.add("gamma_shape_");
allowedParameters.add("gamma_omrates_");
allowedParameters.add("gamma_hyperpriorshape_");
allowedParameters.add("gamma_hyperpriorscale_");
allowedParameters.add("seed1_");
allowedParameters.add("seed2_");
allowedParameters.add("input_branchlengths_");
switchValues.put("input_branchlengths_", switchList);
allowedParameters.add("single_nodemove_");
switchValues.put("single_nodemove_", switchList);
allowedParameters.add("ro_nodemove_");
switchValues.put("ro_nodemove_", switchList);
...
tmpList.add("5");
tmpList.add("6");
exclValues.put("turnoff_move_", tmpList);
allowedParameters.add("turnoff_move_");
allowedParameters.add("print_moves_");
switchValues.put("print_moves_", switchList);
tmpList = new ArrayList<String>();
tmpList.add("1");
tmpList.add("2");
tmpList.add("3");
tmpList.add("4");
exclValues.put("npr_value_", tmpList);
allowedParameters.add("npr_value_");
requiredParameters.add("npr_value_");
allowedParameters.add("starting_val_diverserate_");
allowedParameters.add("relative_ext_");
allowedParameters.add("strict_clock_");
switchValues.put("strict_clock_", switchList);
allowedParameters.add("run_uncorrelated_");
switchValues.put("run_uncorrelated_", switchList);
allowedInput.add("upload_calfile_");
allowedParameters.add("soft_bounds_");
switchValues.put("soft_bounds_", switchList);
allowedParameters.add("offset_exponential_");
switchValues.put("offset_exponential_", switchList);
allowedParameters.add("dpm_hyperprior_");
switchValues.put("dpm_hyperprior_", switchList);
allowedParameters.add("hyperprior_oncal_");
switchValues.put("hyperprior_oncal_", switchList);
}
