...
public class mbsumValidator implements ParameterValidator2
{
...
allowedInput.add("mb_infile1_");
requiredInput.add("mb_infile1_");
allowedParameters.add("skipped_lines_");
allowedParameters.add("num_files_");
allowedInput.add("mb_infile2_");
allowedInput.add("mb_infile3_");
allowedInput.add("mb_infile4_");
allowedInput.add("mb_infile5_");
allowedInput.add("mb_infile6_");
allowedInput.add("mb_infile7_");
allowedInput.add("mb_infile8_");
allowedInput.add("mb_infile9_");
allowedInput.add("mb_infile10_");
}
...
if (parameter.equals("skipped_lines_")) {
