...
public class SSHExecProcessWorker extends BaseProcessWorker 
{
	...
	*/
	...
	private InputStream readFile(String filename, FileHandler handler)  throws Exception
	{
		InputStream is = null;
		int tries = 0;
		try
		...
		{
			m_log.debug("Exception reading:'" + filename + "'. This is not considered fatal.", e);
			return null;
		}
	}
