...
public class mafft_861Validator implements ParameterValidator2
{
...
allowedParameters.add("num_seqs_");
...
tmpList.add("--alga");
tmpList.add("--algq");
exclValues.put("group2groupalg_", tmpList);
allowedParameters.add("group2groupalg_");
tmpList = new ArrayList<String>();
tmpList.add("0");
tmpList.add("1");
