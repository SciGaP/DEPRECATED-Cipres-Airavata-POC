...
public class pepstatsValidator implements ParameterValidator2
{
...
allowedParameters.add("termini_");
switchValues.put("termini_", switchList);
allowedParameters.add("aadata_");
}
