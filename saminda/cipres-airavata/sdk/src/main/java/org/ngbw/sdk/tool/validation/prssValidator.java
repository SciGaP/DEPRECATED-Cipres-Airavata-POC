...
public class prssValidator implements ParameterValidator2
{
...
switchList.add("1");
List<String> tmpList;
allowedInput.add("query1_");
requiredInput.add("query1_");
allowedInput.add("query2_");
requiredInput.add("query2_");
allowedParameters.add("shufflenum_");
...
allowedParameters.add("shuffle_");
}
...
if (parameter.equals("shufflenum_")) {
