...
public class phylobayes_xsede_restartValidator implements ParameterValidator2
{
...
public phylobayes_xsede_restartValidator() {
...
allowedInput.add("chainfile1_");
allowedInput.add("chainfile2_");
allowedInput.add("chainparamfile1_");
allowedInput.add("chainparamfile2_");
allowedInput.add("chaintreefile1_");
allowedInput.add("chaintreefile2_");
allowedInput.add("chaintracefile1_");
allowedInput.add("chaintracefile2_");
allowedInput.add("chainmonfile1_");
allowedInput.add("chainmonfile2_");
}
