...
public class compassValidator implements ParameterValidator2
{
...
allowedInput.add("alignment_number_two_");
requiredInput.add("alignment_number_two_");
allowedParameters.add("gap_threshold_");
allowedParameters.add("gap_threshold_moderate_");
allowedParameters.add("gap_opening_");
allowedParameters.add("gap_extension_");
allowedParameters.add("ungapped_lambda_");
allowedParameters.add("expect_positional_");
allowedParameters.add("database_length_");
allowedParameters.add("alignment_length_");
allowedParameters.add("number_sequences_");
}
