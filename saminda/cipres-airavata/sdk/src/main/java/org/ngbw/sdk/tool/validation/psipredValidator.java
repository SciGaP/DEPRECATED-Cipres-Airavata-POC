...
public class psipredValidator implements ParameterValidator2
{
...
allowedParameters.add("filter_iterations_");
allowedParameters.add("helix_");
...
if (parameter.equals("filter_iterations_")) {
if (BaseValidator.validateInteger(value) == false)
return "Must be an integer.";
return null;
}
if (parameter.equals("helix_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
if (parameter.equals("strand_")) {
if (BaseValidator.validateDouble(value) == false)
return "Must be a Double.";
return null;
}
